        ...
        animationDuration: '0.4s'
          ...
          <div className="text-center space-y-6">
            ...
            <div className="border-2 border-blue-400 bg-white/10 backdrop-blur-sm rounded-lg p-2 mx-auto max-w-fit shadow-[0_0_15px_rgba(96,165,250,0.6)]">
              <p className="text-sm font-bold text-white">{t('paywall_savings_text')}</p>
            </div>
          </div>

          {/* Features List */}
          <div className="space-y-4 backdrop-blur-md rounded-2xl p-6 border border-white/20 bg-gradient-to-br from-slate-800/90 via-slate-900/80 to-blue-900/70 shadow-[0_8px_32px_rgba(37,99,235,0.4)]">
