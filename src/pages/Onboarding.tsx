...
const Onboarding = () => {
  ...
  const faqs = [{
    ...
    answer: "Unsere Preisdaten stammen von der Markttransparenzstelle für Kraftstoffe (MTS-K) und werden kontinuierlich aktualisiert. Die Preise werden mit einer Verzögerung von maximal 5 Minuten angezeigt."
  }, {
